"""
Django settings for autenticacao_autorizacao project.
...
ROOT_URLCONF = 'autenticacao_autorizacao.urls'
...
WSGI_APPLICATION = 'autenticacao_autorizacao.wsgi.application'
